...
-export([set_contents/2, set_vclock/2, set_node/2]). %% INTERNAL, only for riak_*
-export([is_robject/1]).
...
-spec set_node(riak_object(), node()) -> riak_object().
set_node(#r_object{} = Object, Node) -> Object#r_object{node = Node}.
