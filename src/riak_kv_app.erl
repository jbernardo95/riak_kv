...
start(_Type, _StartArgs) ->
    ...
    sidejob:new_resource(riak_kv_transactional_get_fsm_sj, sidejob_supervisor, FSM_Limit),
    ...
    riak_kv_exometer_sidejob:new_entry(Base ++ [transactional_get_fsm, sidejob],
                                       riak_kv_transactional_get_fsm_sj, "node_transactional_get_fsm", []),
